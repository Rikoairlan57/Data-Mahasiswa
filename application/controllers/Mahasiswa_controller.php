...
class Mahasiswa_controller extends CI_Controller
{
  ...
  public function store()
  {
    ...
    $this->form_validation->set_rules('tgl_lahir', 'Tgl_lahir', 'required', array('required' => '%s tidak boleh kosong'));
    $this->form_validation->set_rules('tmp_lahir', 'Tmp_lahir', 'required', array('required' => '%s tidak boleh kosong'));
    $this->form_validation->set_rules('jk', 'jk', 'required', array('required' => '%s tidak boleh kosong'));
    $this->form_validation->set_rules('agama', 'Agama', 'required', array('required' => '%s tidak boleh kosong'));
